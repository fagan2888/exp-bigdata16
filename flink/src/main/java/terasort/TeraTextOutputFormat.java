...
public class TeraTextOutputFormat<T> extends FileOutputFormat<T> {
	...
	public TeraTextOutputFormat(Path outputPath) {
		this(outputPath, "UTF-8");
	}
	
	public TeraTextOutputFormat(Path outputPath, String charset) {
		super(outputPath);
	...
	public String toString() {
		return "TeraTextOutputFormat (" + getOutputFilePath() + ") - " + this.charsetName;
	}
}
