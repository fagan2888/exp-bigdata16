...
class HadoopTeraScheduler {
  static String USE = "mapreduce.terasort.use.terascheduler";
  private static final Log LOG = LogFactory.getLog(HadoopTeraScheduler.class);
  ...
  public HadoopTeraScheduler(String splitFilename, 
  ...
  public HadoopTeraScheduler(FileSplit[] realSplits,
  ...
  public static void main(String[] args) throws IOException {
    HadoopTeraScheduler problem = new HadoopTeraScheduler("block-loc.txt", "nodes");
